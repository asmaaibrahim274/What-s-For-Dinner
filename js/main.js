...
var ratingsQuantity = document.getElementById("ratingsQuantity");
...
console.log(img);
var randomNum = 0;
randomNum = Math.floor(Math.random() * mails.length) + 0;
console.log(randomNum);

Name.innerHTML = mails[randomNum].name;
description.innerHTML = mails[randomNum].description;
// img.outerHTML = `<img id=\"img\" src=\"${mails[randomNum].imgCover}\" alt=\"${mails[randomNum].image}\">`
img.src = mails[randomNum].imgCover;
img.alt = mails[randomNum].image;
difficulty.innerHTML = mails[randomNum].difficulty;
category.innerHTML = mails[randomNum].category;
ratingsAverage.innerHTML = mails[randomNum].ratingsAverage;
ratingsQuantity.innerHTML = mails[randomNum].ratingsQuantity;
var ingredientsCount = "";
for (var i = 0; i < mails[randomNum].ingredients.length; i++) {
    ingredientsCount += `
                                        <div class="d-flex line">
                                        <div class="cir d-flex justify-content-center align-items-center">${i}</div>
                                        ${mails[randomNum].ingredients[i]}
                                        </div>
                                    `
}
var instructionsCount = "";
for (var i = 0; i < mails[randomNum].instructions.length; i++) {
    instructionsCount += `<div class="line d-flex h-100 mb-4">
                                        <div class="cir d-flex justify-content-center align-items-center">${i}</div>
                                        ${mails[randomNum].instructions[i]}
                                    </div>
                                    `
}
var tipsCount = "";
for (var i = 0; i < mails[randomNum].tips.length; i++) {
    tipsCount += `
        <div class="line d-flex p-3 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="true rounded-circle d-flex justify-content-center align-items-center">
                                                <i class="fa-solid fa-check"></i>
                                            </div>
                                            <span>${mails[randomNum].tips[i]}</span>
                                        </div>
                                    </div>
                                    `
}
ingredients.innerHTML = ingredientsCount;
instructions.innerHTML = instructionsCount;
tips.innerHTML = tipsCount;
calories.innerHTML = mails[randomNum].nutrition.calories;
protein.innerHTML = mails[randomNum].nutrition.protein;
carbs.innerHTML = mails[randomNum].nutrition.carbs;
fat.innerHTML = mails[randomNum].nutrition.fat;
fiber.innerHTML = mails[randomNum].nutrition.fiber;
sodium.innerHTML = mails[randomNum].nutrition.sodium;
function reload() {
    randomNum = Math.floor(Math.random() * mails.length) + 0;
    console.log(randomNum);
...
console.log(Math.floor(Math.random() * 19) + 0);
